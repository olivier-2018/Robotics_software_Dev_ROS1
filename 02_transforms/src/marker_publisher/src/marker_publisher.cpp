...
int main(int argc, char **argv)
{
  ...
  while (ros::ok())
  {
    ...
    ROS_INFO("Object position: x=%f, y=%f, z=%f", object.pose.position.x, object.pose.position.y, object.pose.position.z);
    ...
    ROS_INFO("Robot position: x=%f, y=%f, z=%f", robot.pose.position.x, robot.pose.position.y, robot.pose.position.z);
    ...
    ROS_INFO("Camera position: x=%f, y=%f, z=%f", camera.pose.position.x, camera.pose.position.y, camera.pose.position.z);
